...
public class FakeIdentityDaoTest {
    ...
    private final Alias cardholderId = new UkcCardholderIdAlias("11111111");
    ...
    public void shouldSaveIdentity() {
        ...
        assertThat(dao.load(cardholderId)).isEqualTo(expectedIdentity);
    }
    ...
    public void shouldDeleteIdentity() {
        ...
        assertThat(dao.load(cardholderId)).isEmpty();
    }
