...
public class CardCredentialsVerificationMethodDeserializerTest {

    private static final String JSON = JsonLoader.loadJson("/method/card-credentials-verification-method.json");
    ...
    public void shouldDeserializeMethod() throws IOException {
        final VerificationMethod method = MAPPER.readValue(JSON, CardCredentialsVerificationMethod.class);
