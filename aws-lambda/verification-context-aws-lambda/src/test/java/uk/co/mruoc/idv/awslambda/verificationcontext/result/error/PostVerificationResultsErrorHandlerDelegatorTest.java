...
public class PostVerificationResultsErrorHandlerDelegatorTest {

    private final ErrorHandlerDelegator delegator = new PostVerificationResultsErrorHandlerDelegator();
